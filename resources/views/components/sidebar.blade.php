            ...
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('notification') }}">Notifications</a>
                            </li>
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('account') }}">Account</a>
                            </li>
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('setting') }}">Settings</a>
                            </li>
                        </ul>
                    </div>
                </li><!--//nav-item-->
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('login') }}">Login</a>
                            </li>
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('register') }}">Signup</a>
                            </li>
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('reset-password') }}">Reset
                                    password</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('404') }}">404 page</a>
                            </li>
                        </ul>
                    </div>
                </li><!--//nav-item-->
